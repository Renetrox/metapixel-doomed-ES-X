...
A community-maintained ES-X adaptation of mattrixk's MetaPixel theme with additional tweaks and systems.  
...
All credits belong to the original author and contributors.  

## INSTALLATION
This theme is available directly from the **Theme Browser** in **EmulationStation-X**.  

If you prefer manual installation:
```bash
mkdir -p /opt/retropie/configs/all/emulationstation/themes
cd /opt/retropie/configs/all/emulationstation/themes
git clone --depth 1 https://github.com/RapidEdwin08/metapixel-doomed-ES-X.git
cd ~
```
